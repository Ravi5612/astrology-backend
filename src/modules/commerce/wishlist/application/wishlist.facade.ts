...
export class WishlistFacade {
  ...
  async addExpertToWishlist(userId: string, expertId: number) {
    return this.addExpertUseCase.execute(userId, expertId);
  }

  async removeExpertFromWishlist(userId: string, expertId: number) {
  ...
  async addPujaToWishlist(userId: string, pujaId: number) {
    return this.addPujaUseCase.execute(userId, pujaId);
  }

  async removePujaFromWishlist(userId: string, pujaId: number) {
  ...
  async addMerchantToWishlist(userId: string, merchantId: number) {
    return this.addMerchantUseCase.execute(userId, merchantId);
  }

  async removeMerchantFromWishlist(userId: string, merchantId: number) {
